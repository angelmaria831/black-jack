...
export default function Home() {
    ...
    return (
        <div className="relative w-full h-screen">
            <nav className="fixed top-0 left-0 w-full py-8 px-6 bg-gradient-to-b from-black to-transparent z-20">
                <div className="flex justify-between items-center max-w-7xl mx-auto">
                    <h1 className="text-2xl font-bold text-white">BlackJack</h1>
                    <span className="text-white text-xl cursor-pointer hover:text-red-400 hover:font-bold transition duration-300">Rules</span>
                </div>
            </nav>
